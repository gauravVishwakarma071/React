...
const RightCardContent = () => {
    return (
        <div className='p-5 h-full w-full rounded-4xl absolute top-0 left- flex flex-col justify-between'>
            ...
            <div>
                <p className='text-xl leading-relaxed text-white mb-10 font-medium'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum iste tempora provident.</p>
